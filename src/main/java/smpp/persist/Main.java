...
class Main {
    ...
    public static void main(String[] args) throws IOException, RecoverablePduException, InterruptedException,
        ...
        ReceiveSmppClientMessageService smppClientMessageService = new ReceiveSmppClientMessageService();
        int i = 0;
                        ...
                        try {
                            ...
                            while (sent <= messagesToSend) {
                                ...
                                if (session != null && session.isBound()) {
                                    ...
                                    submit.setSourceAddress(new Address((byte) 0x03, (byte) 0x00, "000"));
    ...
    private static OutboundClient createClient(ReceiveSmppClientMessageService smppClientMessageService, int i) {
